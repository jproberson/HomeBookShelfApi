...
class BookRecommendationServiceTests {
  ...
  @MockK private lateinit var userService: UsersService

  @MockK private lateinit var gptService: GptService

  @MockK private lateinit var bookService: BookService

  @MockK private lateinit var bookRecommendationRepository: BookRecommendationRepository

  @InjectMockKs private lateinit var bookRecommendationService: BookRecommendationServiceImpl
