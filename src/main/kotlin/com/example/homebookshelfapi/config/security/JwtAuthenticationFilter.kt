...
import com.example.homebookshelfapi.services.security.CustomUserDetailsService
import com.example.homebookshelfapi.services.security.TokenService
...
class JwtAuthenticationFilter(
    ...
    override fun doFilterInternal(
        ...
        if (username != null && SecurityContextHolder.getContext().authentication == null) {
            ...
            if (tokenService.isValid(jwtToken)) updateContext(foundUser, request)
